...
inner10 = outer(10)
code = inner10.__code__
cells = inner10.__closure__
fake_closure = types.FunctionType(code, globals(), "fake_inner10", None, cells)
print(fake_closure(30))

print(globals())

code = normal.__code__
fake_normal = types.FunctionType(code, globals(), "fake_normal", (20, 30), None)
print(fake_normal())


code = normal_no_para.__code__
globals()["x"] = 100
globals()["y"] = 200
fake_normal_no_para = types.FunctionType(
    code, globals(), "fake_normal_no_para", None, None
)
print(fake_normal_no_para())
