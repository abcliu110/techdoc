...
CREATE TABLE `order_bill`  (
  ...
  `spec_require` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '特殊要求 R:叫起  S:即上',
  `refund_state` int NULL DEFAULT NULL COMMENT '退款状态',
  `refund_for` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '退款原因多次用，隔开',
  `refund_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '退款人多次用，隔开',
  `refund_at` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '退款时间多次用，隔开',
  `refund_amount` decimal(19, 8) NULL DEFAULT NULL COMMENT '退款金额多次用，隔开',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4083 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单评价' ROW_FORMAT = Dynamic;
