...
- [ ] **Step 2: Write and run failing assembler tests**
...
- [ ] **Step 1: Write and run failing structural tests**
...
- [ ] **Step 2: Implement the bounded validator**
...
- [ ] **Step 1: Write and run failing semantic tests**
...
- [ ] **Step 2: Author the complete candidate specification**
...
- [ ] **Step 3: Implement registered semantic checks**
...
- [ ] **Step 1: Write and run failing SOP-reference tests**
...
- [ ] **Step 2: Implement path, pointer, digest and duplication validation**
...
- [ ] **Step 3: Author the structured SOP candidate**
...
- [ ] **Step 1: Write and run failing generation tests**
...
- [ ] **Step 2: Implement the minimum generator**
...
- [ ] **Step 3: Add the one-shot verifier**
