---
id: E-NOCOBASE-SRC-048
type: evidence
competitor: NocoBase
module: permission
source_channel: github-source
source_type: source-code
source_url: https://github.com/nocobase/nocobase/blob/develop/packages/core/acl/src/acl.ts
...
# Evidence: NocoBase ACL core middleware
...
ACL adds core middleware to merge permission params into resource actions.
