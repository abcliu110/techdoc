---
id: E-NOCOBASE-SRC-090
type: evidence
competitor: NocoBase
module: workflow
source_channel: github-source
source_type: source-code
source_url: https://github.com/nocobase/nocobase/blob/develop/packages/plugins/@nocobase/plugin-workflow/src/server/collections/workflows.ts
...
# Evidence: NocoBase workflow categories relation
...
Workflow metadata includes a belongsToMany relation to workflowCategories.
