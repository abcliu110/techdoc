---
id: E-NOCOBASE-SRC-012
type: evidence
competitor: NocoBase
module: data-model
source_channel: github-source
source_type: source-code
source_url: https://github.com/nocobase/nocobase/blob/develop/packages/core/database/src/collection.ts
...
# Evidence: NocoBase filterTargetKey
...
CollectionOptions includes filterTargetKey for selecting filtering or identity target fields.
