...
表格组件族已经选择“DataGrid 核心 + 内部能力模块 + TanStack 适配层”的演进路线，34 项目录能力的归类、首批范围与 TreeGrid 扩展边界见[表格组件族实施设计](02-组件规范/02-表格类/02-表格组件族实施设计.md)。该文件是技术设计，不替代单组件规范或生产 SOP，也不单独授权编码。
