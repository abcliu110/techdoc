---
id: E-NOCOBASE-SRC-068
type: evidence
competitor: NocoBase
module: ui-view
source_channel: github-source
source_type: source-code
source_url: https://github.com/nocobase/nocobase/blob/develop/packages/plugins/@nocobase/plugin-ui-schema-storage/src/server/repository.ts
...
# Evidence: NocoBase prepare single UI schema node
...
UiSchemaRepository prepares uid, name, async flag, and child options for inserted nodes.
