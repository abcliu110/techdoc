...
# Evidence: Frappe get_doc_permissions

## Source location

- Repository file: $RepoPath
- Local file: $LocalFile
- Version: GitHub develop source as captured on 2026-07-05
- Line: L141
- Anchor pattern: $Pattern

## Observation

Frappe evaluates document-specific permissions with get_doc_permissions.
