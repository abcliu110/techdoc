...
(
    ...
    `maincai` Nullable(Int64) COMMENT '主菜ID，NULL或0表示单品，>0表示套餐子项',
    `dish_category_type` Nullable(Int8) COMMENT '菜品类型：1-套餐 2-套餐子菜 3-单品',
    `maincais` Array(Int64) COMMENT '主菜ids',
    `dish_category_types` Array(Int32) COMMENT '订单类型',
    `sub_gross_sales_amt` Decimal(24, 6) DEFAULT 0,
    `sub_net_sales_amt` Decimal(24, 6) DEFAULT 0,
    `sub_returned_amt` Decimal(24, 6) DEFAULT 0,
    `sub_free_amt` Decimal(24, 6) DEFAULT 0,
    `sub_food_service_charge_amt` Decimal(24, 6) DEFAULT 0,
    `sub_food_discount_amt` Decimal(24, 6) DEFAULT 0,
    `sub_food_processing_fee_amt` Decimal(24, 6) DEFAULT 0,
    `sub_processing_service_charge_amt` Decimal(24, 6) DEFAULT 0,
    `sub_processing_fee_discount_amt` Decimal(24, 6) DEFAULT 0,
    `sub_receivable_amt` Decimal(24, 6) DEFAULT 0,
    `sub_price_diff_amt` Decimal(24, 6) DEFAULT 0
)
