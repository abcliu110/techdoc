...
(
    ...
    `food_pro_price` Decimal(18, 4) COMMENT '售价',
    `food_org_price` Decimal(18, 4) COMMENT '原价',
...
PRIMARY KEY (mid, sid, year_, month_, day_, food_name, food_unit)
ORDER BY (mid, sid, year_, month_, day_, food_name, food_unit)
